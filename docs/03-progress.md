...
**同步規則**：本檔與 [candor-core docs/04-integration-progress.md](https://github.com/DaydreamLab/candor-core/blob/main/docs/04-integration-progress.md) 的 Younger 區必須一致。接線狀態變更時兩邊一起改。
...
**最後更新**：2026-09-25（建議、`package-plans`、goals／價格帶確認、常用收件、解除報告綁定已接；訂單建單／列表／詳情已接；續約、重新付款、取消仍 Mock）
