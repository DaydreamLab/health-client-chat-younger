...
| `--ui-success` | `text-success` | `#17C114` = forest-600 | `#67D665` = forest-400 | 指標正常 |
| `--ui-warning` | `text-warning` | `#F2A01D` = sand-600 | `#F6C16B` = sand-400 | 指標偏低 |
| `--ui-error` | `text-error` | `#E00017` = coral-600 | `#EB5867` = coral-400 | 登入錯誤、指標偏高 |
| `--ui-info` | `text-info` | `#278AFB` = lagoon-600 | `#71B2FC` = lagoon-400 | 資訊／公告 |
...
| 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 950 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `#F1FBF1` | `#DDF6DC` | `#BBEDBA` | `#95E394` | `#67D665` **用** | `#36C933` | `#17C114` **用** | `#12930F` | `#0C690B` | `#094807` | `#063405` |
...
| 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 950 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `#FEF9F1` | `#FDF1DE` | `#FBE3BD` | `#F9D498` | `#F6C16B` **用** | `#F4AD3B` | `#F2A01D` **用** | `#B87A16` | `#835710` | `#5B3C0B` | `#412B08` |
...
| 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 950 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `#FDEFF1` | `#FAD9DD` | `#F6B4BB` | `#F18B95` | `#EB5867` **用** | `#E42236` | `#E00017` **用** | `#AA0012` | `#79000C` | `#540009` | `#3C0006` |

- `text-error`：日間 600 `#E00017`、夜間 400

### lagoon → info

| 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 950 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `#F2F8FF` | `#DFEEFE` | `#C0DDFE` | `#9DCAFD` | `#71B2FC` **用** | `#449AFC` **用** | `#278AFB` **用** | `#1E69BF` | `#154B88` | `#0F345E` | `#0A2544` |
